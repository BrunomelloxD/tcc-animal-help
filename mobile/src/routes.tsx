...
import RegistrationPatient from './pages/CreatePatient/RegistrationPatient'
            ...
            >
                ...
                <Screen
                    ...
                    options={{
                        headerShown: true,
                        header: () => (
                            <Header title="Mapa de ONG's" isMap={true} />
                        )
                    }}
                />
                <Screen
                ...
                />
                <Screen
                    name="RegistrationOng"
                    component={RegistrationOng}
                    options={{
                        headerShown: true,
                        header: () => (
                            <Header title="Informe os dados" isMap={false} />
                        )
                    }}
                />
                <Screen
                ...
                <Screen
                    ...
                    options={{
                        headerShown: true,
                        header: () => (
                            <Header title="Selecione no mapa" isMap={false} />
                        )
                    }}
                />
                ...
                <Screen
                    ...
                    options={{
                        headerShown: true,
                        header: () => <Header title="Adoção" isMap={false} />
                    }}
                />
                ...
                <Screen
                    ...
                    options={{
                        headerShown: true,
                        header: () => (
                            <Header title="Amigo não se compra" isMap={false} />
                        )
                    }}
                />
            </Navigator>
